  <nav class="navbar navbar-expand-md navbar-dark bg-dark-opaque mobile-navbar">
  <div class="container">
    <a class="navbar-brand d-none d-md-block" href="{{ url('/') }}">
      {{ config('app.name', 'Grateful') }}
    </a>
    <div class="collapse navbar-collapse show-mobile" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto text-white">
        <li class="nav-item text-white">
          <a class="nav-link {{ (request()->is('veikali*')) ? 'text-white' : '' }}" href="/veikali">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (request()->is('karte')) ? 'text-white' : '' }}" href="/karte">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (request()->is('pirkumi')) ? 'text-white' : '' }}" href="/pirkumi">
        ...
        <li class="nav-item">
          <a class="nav-link {{ (request()->is('profils')) ? 'text-white' : '' }}" href="/profils">
      ...
      <ul class="navbar-nav ml-auto d-none d-md-flex">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item" href="/dashboard">Vadības panelis</a>
            <?php endif; ?>
